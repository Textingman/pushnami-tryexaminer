            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <a href="mailto:support@tryexaminer.com" className="text-base font-medium hover:underline" style={{ color: '#1D4ED8' }}>support@tryexaminer.com</a>
                ...
                <div>
                  ...
                  <p style={{ color: '#6B7280' }}>Examiner<br />6106 Cherrylawn Cir<br />Austin, TX 78723</p>
                </div>
                <div>
