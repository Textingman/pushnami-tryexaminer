    ...
    <footer className="text-white py-12" style={{ backgroundColor: '#1E3A5F' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Examiner</h3>
            <p style={{ color: '#BFDBFE' }}>
              Your AI agent for navigating forms and paperwork — fast.
            </p>
            {/* Social Icons */}
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/signup" style={{ color: '#BFDBFE' }} className="hover:text-white">Try Examiner Free</Link></li>
            </ul>
          </div>
          <div>
        ...
        <div className="mt-8 pt-8 text-center" style={{ borderTop: '1px solid #1D4ED8', color: '#BFDBFE' }}>
          <p>&copy; 2026 Examiner. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
